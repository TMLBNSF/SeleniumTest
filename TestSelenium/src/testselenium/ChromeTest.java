...
public void testChrome() throws InterruptedException {
	...
	driver.manage().window().maximize();
	 ...
	 //Date
	 driver.findElement(By.cssSelector("input[type='date']")).sendKeys("09252017");
	...
	//Comments
	 driver.findElement(By.cssSelector("textarea[jsname='YPqjbf']")).sendKeys("Please enter some Text");
	  
	 //Income
	 driver.findElement(By.cssSelector("div[aria-label='$60000-$80000']")).click();
